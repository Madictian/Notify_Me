...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setNoticationButtonState(true, false, false);
    ...
    public void updateNotification(){
        ...
        notifyBuilder.setStyle(new NotificationCompat
                                                    .BigPictureStyle()
                                                    .bigPicture(androidImage)
                                                    .setBigContentTitle("Notification Updates!"));

        mNotifyManager.notify(NOTIFICATION_ID, notifyBuilder.build());
        setNoticationButtonState(false, false, true);
    }
    ...
    public void setNoticationButtonState(Boolean isNotifyEnabled, Boolean isUpdateEnabled, Boolean isCancelEnabled){
    ...
    public void sendNotification() {
        ...
        setNoticationButtonState(false, true, true);
